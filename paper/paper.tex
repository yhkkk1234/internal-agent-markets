...
All code and experiment configurations are available in the accompanying repository.\footnote{The full experimental framework, including environment, market mechanism, training infrastructure, and all configuration presets, is available at: \texttt{F:/Test11/survival\_market/}. Run with: \texttt{python main\_dual.py --mode both}.}
...
\begin{center}
\small
Code repository and experimental data available at: \texttt{F:/Test11/survival\_market/}.\\
